...
<title>ARAL : Android-based Resources Application for Learning - Section</title>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="<?php echo strtolower($subject['code']); ?>Table" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <td>Student Name</td>
                                                <td>Score</td>
                                        ...
                                        GROUP BY u.id");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo ucfirst($class['date_time']); ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
