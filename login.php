...
<head>
    ...
    <title>ARAL : Android-based Resources Application for Learning - Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">ARAL : Android-based Resources Application for Learning -  <?php echo date("Y"); ?></h1>
                                    </div>
